...
num_holes = 30  # this is the number of pillars we will build
num_height = 30
min_r = 0.0
max_r = 0.245
min_h = 1.02
...
file_name='combined_data.pkl'
name = os.path.join(results_path,file_name)

#from IPython import embed; embed()


pickle.dump(combined_data, open(name, "wb"))

file_name='combined_initial_flux.pkl'
name = os.path.join(results_path,file_name)
pickle.dump(combined_initial_flux, open(name, "wb"))
